...
tattoosList = {
	["new_overlays"] = {
		...
		{nameHash = "new_tattoo_01_M", addedX = 0.3, addedY=-0.7,addedZ=0.5,rotZ = 17.7, price = 500}
...
tattoosCategories = {
	{name = "Part 1", value = "new_overlays"},
	{name = "Part 2", value = "mpbeach_overlays"},
	{name = "Part 3", value = "mpbusiness_overlays"},
	{name = "Part 4", value = "mphipster_overlays"}
}
